...
{
    public class ELRDDbMigrationService : ITransientDependency
    {
        public ILogger<ELRDDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IELRDDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public ELRDDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IELRDDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<ELRDDbMigrationService>.Instance;
        }
